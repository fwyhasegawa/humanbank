 ...
 */
	public function testMultibyteFormat() {
		...
		$expected = '519ﾃｸ竄ｬﾆ停｡邃｢919ﾃｸ竄ｬﾆ停｡邃｢827ﾃｸ竄ｬﾆ停｡邃｢593ﾃｸ竄ｬﾆ停｡邃｢784(ﾂｧ.ﾂｧ)00竄ｬ';
		$this->assertEquals($expected, $result);
		...
		$expected = '13- |-| /-\ &gt;&lt; () |2 -371- |-| /-\ &gt;&lt; () |2 -337- ﾂ｣竄ｬ竄ｬ窶 -13';
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testCurrency() {
		...
		$result = $this->Number->currency($value, '', array('thousands' => ' ', 'wholeSymbol' => '竄ｬ', 'wholePosition' => 'after', 'decimals' => ',', 'zero' => 'Gratuit'));
		$expected = '100 100 100,00竄ｬ';
		$this->assertEquals($expected, $result);

		$result = $this->Number->currency(1000.45, null, array('after' => 'ﾃｸre', 'before' => 'Kr. ', 'decimals' => ',', 'thousands' => '.'));
		...
		$result = $this->Number->currency(0.5, null, array('after' => 'ﾃｸre'));
		$expected = '50ﾃｸre';
		$this->assertEquals($expected, $result);
