 ...
 */
	public function testParseServerStringNonLatin() {
		...
		$result = $Memcache->parseServerString('sch端lervz.net:13211');
		$this->assertEquals(array('sch端lervz.net', '13211'), $result);

		$result = $Memcache->parseServerString('s端l端l:1111');
		$this->assertEquals(array('s端l端l', '1111'), $result);
	}
