...
<?php echo $this->Form->create('DboTAttendance'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dbo T Attendance'); ?></legend>
	<?php
		...
		echo $this->Form->input('dbo_m_teates_id1', array('label'=> '手当詳細ID１'));
		echo $this->Form->input('dbo_m_teates_id2', array('label'=> '手当詳細ID２'));
		echo $this->Form->input('dbo_m_teates_id3', array('label'=> '手当詳細ID３'));
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('この項目を削除'), array('action' => 'delete', $this->Form->value('DboTAttendance.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DboTAttendance.id'))); ?></li>
