...
<?php echo $this->Form->create('DboMClient'); ?>
	<fieldset>
		<legend><?php echo __('顧客マスタ追加'); ?></legend>
	<?php
		...
		echo $this->Form->input('dbo_m_days_id_cutoff', array('label'=> '締め日', 'type'=>'select', 'options'=>$dboMDays1));
		echo $this->Form->input('dbo_m_days_id_pay', array('label'=> '支払い日', 'type'=>'select', 'options'=>$dboMDays2));
