...
<?php echo $this->Form->create('DboTPayment'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dbo T Payment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('削除'), array('action' => 'delete', $this->Form->value('DboTPayment.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DboTPayment.id'))); ?></li>
